 ...
 * @author geliang
 */
define("focus/touch-modal/0.1.0/touch-modal-debug", [ "underscore-debug", "$-debug", "events-debug" ], function(require, exports, module) {
    ...
    Modal.prototype = {
        ...
        show: function() {
            this.setStyle();
            setTimeout(_.bind(this.showMask, this), 1);
