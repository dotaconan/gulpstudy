 ...
 */
define('xyzui-drag-sea',['$'],function (require, exports, module) {
    //依赖模块jquery
    var $ = require('$');
 ...
 * Created by lucheng0902 on 2016/1/5.
 */
define('xyzui-dialog-sea',['$','xyzui-drag-sea'],function (require, exports, module) {
    //依赖模块jquery
    var $ = require('$');
    var Drag = require('xyzui-drag-sea');
 ...
 * Created by lucheng0902 on 2016/1/5.
 */
define('xyzui-slide-sea',['$'],function (require, exports, module) {
    //依赖模块jquery
    var $ = require('$');
...
define('cookie',[],function(e,t){function s(e,t){var n={};if(o(e)&&e.length>0){var i=t?r:f,s=e.split(/;\s/g),u,a,l;for(var c=0,h=s.length;c<h;c++){l=s[c].match(/([^=]+)=/i);if(l instanceof Array)try{u=r(l[1]),a=i(s[c].substring(l[1].length+1))}catch(p){}else u=r(s[c]),a="";u&&(n[u]=a)}}return n}function o(e){return typeof e=="string"}function u(e){return o(e)&&e!==""}function a(e){if(!u(e))throw new TypeError("Cookie name must be a non-empty string")}function f(e){return e}var n=t,r=decodeURIComponent,i=encodeURIComponent;n.get=function(e,t){a(e),typeof t=="function"?t={converter:t}:t=t||{};var n=s(document.cookie,!t.raw);return(t.converter||f)(n[e])},n.set=function(e,t,n){a(e),n=n||{};var r=n.expires,s=n.domain,o=n.path;n.raw||(t=i(String(t)));var f=e+"="+t,l=r;return typeof l=="number"&&(l=new Date,l.setDate(l.getDate()+r)),l instanceof Date&&(f+="; expires="+l.toUTCString()),u(s)&&(f+="; domain="+s),u(o)&&(f+="; path="+o),n.secure&&(f+="; secure"),document.cookie=f,f},n.remove=function(e,t){return t=t||{},t.expires=new Date(0),this.set(e,"",t)}});
/**
 * Created by Administrator on 16-1-14.
 */
/*文件入口*/
define('gulpstudy',['cookie','xyzui-slide-sea','xyzui-dialog-sea'],function (require, exports, module) {

    //引入通用库
    var cookie = require('cookie');
    //引入模块
    var xyzuiSlide = require('xyzui-slide-sea');
    //引入插件中依赖其他插件的库文件
    var xyzuiDialog = require('xyzui-dialog-sea');
...
seajs.use('gulpstudy', function (page) {
    console.log(page);
});
